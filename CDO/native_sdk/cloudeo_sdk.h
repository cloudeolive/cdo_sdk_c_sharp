 ...
 * @return 
 */
void cdo_render_sink(cdo_int_rclbck_t rclbck, CDOH handle, void* opaque,
 ...
 * @param rendererId
 */
void cdo_stop_render(cdo_void_rclbck_t rclbck, CDOH handle, void* opaque,
        int rendererId);
 ...
 * @return 
 */
void cdo_draw(CDOH handle, const CDODrawRequest* request);
